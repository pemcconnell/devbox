...
RUN mkdir -p /home/dev /home/dev/Sites /home/dev/GoWorkspaces /home/dev/tmp /home/dev/bin && \
...
# golang
RUN curl https://storage.googleapis.com/golang/go1.6.2.linux-amd64.tar.gz | tar -C /usr/local -zx
